...
<body>
  ...
  <label for="tab3">User Profile</label>
	                ...
	                <div class="card-body">
	                    <form method="POST" action="profile">
							...
							<div class="form-group row">
	                            ...
	                            <div class="col-md-6">
	                                <input id="firstname" type="text" class="form-control" name="firstname" required autofocus readonly>
	                            </div>
	                        </div>
	                        ...
	                        <div class="form-group row">
	                            ...
	                            <div class="col-md-6">
	                                <input id="lastname" type="text" class="form-control" name="lastname" required autofocus readonly>
	                            </div>
	                        </div>
	                        ...
	                        <div class="form-group row">
	                            ...
	                            <div class="col-md-6">
	                                <input id="email" type="email" class="form-control" name="email" required autofocus readonly>
	                            </div>
						...
						<div class="form-group row" id ="old-passwd" style="display:none;" >
							...
							<div class="form-group row" id ="new-passwd" style="display:none;">
	                            <label for="password" class="col-md-4 col-form-label text-md-right" id = "passwd-label"> Password</label>
	                        ...
	                        <div class="form-group row" id ="confirmation" style="display:none;">
	                        ...
	                        <div class="form-group row mb-0" id ="change-passwd" style="display:none;">
	                            <div class="col-md-8 offset-md-4">
