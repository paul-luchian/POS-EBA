	...
	$.ajax({
		...
		success : function(data) {
			...
			if (data !== null) {
				...
				// cookie-valid -> redirect to /services/profile/{id} ca sa
				// rezulte o ruta: /services/profile/ddhdhsalkeuio47y4nj
				console.log("get data");
				$.ajax({
					type : "GET",
					dataType : "text",
					url : "content/profile.jsp",
					data : {
						"user_id" : data
					},
					success : function(data) {
						location.assign("content/profile.jsp");
					}
				});
			} else {
				location.assign("login/login.jsp");
			}
		}
	});
});