...
public class AdminServicesImpl implements AdminServices {
	...
	@Override
	public String getUsersRequest(HttpServletRequest httpRequest, String username, UserType role,
			String password) {
		...
		try {
			...
			BufferedReader rdp = new BufferedReader(
					new InputStreamReader(profile_response.getEntity().getContent()));
